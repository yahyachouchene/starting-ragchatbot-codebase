...
class MockAnthropicResponse:
    ...
    def __init__(self, content_text: str = None, tool_use_blocks: List[Dict] = None, stop_reason: str = "end_turn"):
...
class MockToolManager:
    ...
    def __init__(self):
        self.execute_calls = []
        self.last_sources = [{"text": "Test Course - Lesson 1", "link": "http://example.com"}]
...
class TestAIGenerator(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.ai_generator = AIGenerator(api_key="test_key", model="claude-3-haiku-20240307")
    ...
    def test_two_round_sequential_tool_calling(self, mock_anthropic_class):
        ...
        final_response = MockAnthropicResponse(content_text="Based on my search, here's the comparison...")
        ...
        self.assertEqual(self.mock_tool_manager.execute_calls[0]["name"], "get_course_outline")
        self.assertEqual(self.mock_tool_manager.execute_calls[1]["name"], "search_course_content")
    ...
    def test_early_termination_no_tool_use(self, mock_anthropic_class):
        ...
        mock_response = MockAnthropicResponse(content_text="Direct answer without tools")
        mock_client.messages.create.return_value = mock_response
    ...
    def test_tool_execution_error_handling(self, mock_anthropic_class):
        ...
        tool_response = MockAnthropicResponse(
            tool_use_blocks=[{
                "name": "search_course_content",
                "input": {"query": "error query"},  # This will trigger an error in mock
                "id": "tool_error"
            }],
            stop_reason="tool_use"
        )
    ...
    def test_context_preservation_between_rounds(self, mock_anthropic_class):
        ...
        conversation_history = "Previous: User asked about Course X. Assistant: Course X covers ML basics."
        ...
        final_response = MockAnthropicResponse(content_text="Here are the advanced topics...")
    ...
    def test_max_rounds_enforcement(self, mock_anthropic_class):
        ...
        final_response = MockAnthropicResponse(content_text="Final response after 2 rounds")
